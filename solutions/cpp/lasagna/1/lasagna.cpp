...
*/
int remainingOvenTime(int actual_minutes_in_oven) {
...
// far.
int elapsedTime(int number_of_layers, int actual_minutes_in_oven) {
    // TODO: Calculate and return the total time so far.
    return preparationTime(number_of_layers) + actual_minutes_in_oven;
}
